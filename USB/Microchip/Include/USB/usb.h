...
#include "USB/Microchip/Include/USB/usb_common.h"         // Common USB library definitions
#include "USB/Microchip/Include/USB/usb_ch9.h"            // USB device framework definitions

#if defined( USB_SUPPORT_DEVICE )
    #include "USB/Microchip/Include/USB/usb_device.h"     // USB Device abstraction layer interface
#endif
...
#include "USB/Microchip/Include/USB/usb_hal.h"            // Hardware Abstraction Layer interface
